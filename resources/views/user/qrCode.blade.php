        ...
        <div class="d-flex flex-column justify-content-center align-items-center pt-4" style="height: calc(100vh - 90px - 60px);">
            <div class="qrcode-container text-center position-relative">
                <div  class="position-absolute" style="top:-20px;left:50%;transform:translateX(-50%);background-color:var(--bl-clr-primary);border:10px solid var(--bl-clr-primary);border-radius:var(--br-primary);">
                    @if(Auth::user()->img)
                        <img src="{{ asset(Auth::user()->img) }}" width="40px" style="border-radius: 50%;"/>
                    @else
                ...
                <div class="position-relative mb-3" style="color: var(--bl-clr-gray-40);font-size: .9rem;top:-6px;"> EventManager &#8212; WebApp </div>
                <div class="qrcode">
                    <img src="{{ $qrcode }}" alt="" width="200px">
                </div>
                <div class="pt-1" style="color: var(--bl-clr-gray-50);font-size: .6rem;">
